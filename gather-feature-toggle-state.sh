...
docker cp edx.${COMPOSE_PROJECT_NAME}.credentials:/edx/app/credentials/credentials/credentials_waffle.json feature-toggle-data
...
docker cp edx.${COMPOSE_PROJECT_NAME}.discovery:/edx/app/discovery/discovery/discovery_waffle.json feature-toggle-data
...
docker cp edx.${COMPOSE_PROJECT_NAME}.ecommerce:/edx/app/ecommerce/ecommerce/ecommerce_waffle.json feature-toggle-data
...
docker cp edx.${COMPOSE_PROJECT_NAME}.lms:/edx/app/edxapp/edx-platform/lms_waffle.json feature-toggle-data
docker cp edx.${COMPOSE_PROJECT_NAME}.lms:/edx/app/edxapp/edx-platform/lms_waffle_utils.json feature-toggle-data
